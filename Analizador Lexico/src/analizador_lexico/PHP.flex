...
stringCharacter = [^\u2028\u2029\u000A\u000B\u000C\u000D\u0085\"\\]
escapeSequence = \\[^\u2028\u2029\u000A\u000B\u000C\u000D\u0085]|\\
string = \"({stringCharcter} | {escapeSequence})*\"
/*string = ((\"(([^\\\"])|([\\\"]))*\") | (\'(([^\\\"])|([\\\"]))*\'))*/
variable = \${identifier}
%%
...
{variable} {token = yytext(); return VAR}
...
"_CLASS_" {return _CLASS_C}
"_DIR_" {return _DIR_C}
"_FILE_" {return _FILE_C}
"_FUNCTION_" {return _FUNCTION_C}
"_LINE_" {return _LINE_C}
"_METHOD_" {return _METHOD_C}
"_NAMESPACE" {return _NAMESPACE_C}
"_TRAIT_" {return _TRAIT_C}
